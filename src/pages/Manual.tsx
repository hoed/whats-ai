  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute -top-40 -left-20 w-96 h-96 bg-blue-500 rounded-full opacity-10 blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-40 right-20 w-96 h-96 bg-purple-500 rounded-full opacity-10 blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <main className="relative z-10 max-w-7xl mx-auto py-12 px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            <Card className="bg-gray-900/70 border-gray-800 sticky top-6">
              <CardHeader>
                <CardTitle className="text-xl">Daftar Isi</CardTitle>
                <CardDescription>Panduan penggunaan AIConverse</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm">
                  <li>
                    <a href="#intro" className="flex items-center text-blue-400 hover:text-blue-300">
                      <Bot className="h-4 w-4 mr-2" />
                      Pengenalan
                    </a>
                  </li>
                  <li>
                    <a href="#whatsapp" className="flex items-center text-blue-400 hover:text-blue-300">
                      <MessageSquare className="h-4 w-4 mr-2" />
                      Integrasi WhatsApp
                    </a>
                  </li>
                  <li>
                    <a href="#ai-profiles" className="flex items-center text-blue-400 hover:text-blue-300">
                      <Sparkles className="h-4 w-4 mr-2" />
                      Profil AI
                    </a>
                  </li>
                  <li>
                    <a href="#contacts" className="flex items-center text-blue-400 hover:text-blue-300">
                      <Users className="h-4 w-4 mr-2" />
                      Kontak
                    </a>
                  </li>
                  <li>
                    <a href="#templates" className="flex items-center text-blue-400 hover:text-blue-300">
                      <FileText className="h-4 w-4 mr-2" />
                      Template
                    </a>
                  </li>
                  <li>
                    <a href="#settings" className="flex items-center text-blue-400 hover:text-blue-300">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1" className="border-gray-800">
                      <AccordionTrigger className="text-blue-400">1. Buat Akun WhatsApp Business</AccordionTrigger>
                      <AccordionContent>
                        <ol className="list-decimal pl-5 space-y-2">
                          <li>Kunjungi <a href="https://business.facebook.com" className="text-blue-400 underline">Meta Business Suite</a></li>
                    ...
                    <AccordionItem value="item-2" className="border-gray-800">
                      <AccordionTrigger className="text-blue-400">2. Dapatkan Akses WhatsApp Business API</AccordionTrigger>
                      <AccordionContent>
                        <ol className="list-decimal pl-5 space-y-2">
                    ...
                    <AccordionItem value="item-3" className="border-gray-800">
                      <AccordionTrigger className="text-blue-400">3. Konfigurasikan di AIConverse</AccordionTrigger>
                      <AccordionContent>
                        <ol className="list-decimal pl-5 space-y-2">
            ...
            <section id="ai-profiles" className="scroll-mt-16">
              <Card className="bg-gray-900/70 border-gray-800">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1" className="border-gray-800">
                      <AccordionTrigger className="text-blue-400">Cara Membuat Profil AI</AccordionTrigger>
                      <AccordionContent>
                        <ol className="list-decimal pl-5 space-y-2">
                    ...
                    <AccordionItem value="item-2" className="border-gray-800">
                      <AccordionTrigger className="text-blue-400">Tips Membuat Prompt yang Efektif</AccordionTrigger>
                      <AccordionContent>
                        <ul className="list-disc pl-5 space-y-2">
            ...
            <section id="settings" className="scroll-mt-16">
              <Card className="bg-gray-900/70 border-gray-800">
                ...
                <CardContent>
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1" className="border-gray-800">
                      <AccordionTrigger className="text-blue-400">Kunci API AI</AccordionTrigger>
                      <AccordionContent>
                        <p className="mb-2">Untuk menggunakan model AI, Anda perlu menambahkan kunci API:</p>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>OpenAI: Dapatkan kunci API dari <a href="https://platform.openai.com/api-keys" className="text-blue-400 underline">platform.openai.com</a></li>
                          <li>Google Gemini: Dapatkan kunci API dari <a href="https://aistudio.google.com/app/apikey" className="text-blue-400 underline">Google AI Studio</a></li>
                    ...
                    <AccordionItem value="item-2" className="border-gray-800">
                      <AccordionTrigger className="text-blue-400">Bahasa Aplikasi</AccordionTrigger>
                      <AccordionContent>
                        <ul className="list-disc pl-5 space-y-2">
                    ...
                    <AccordionItem value="item-3" className="border-gray-800">
                      <AccordionTrigger className="text-blue-400">Notifikasi</AccordionTrigger>
                      <AccordionContent>
                        <ul className="list-disc pl-5 space-y-2">
      ...
      <footer className="relative z-10 py-8 px-6 border-t border-gray-800/50 backdrop-blur-sm mt-12">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-sm text-gray-500">
            &copy; 2025 AIConverse. Semua hak dilindungi.
          </p>
        </div>
      </footer>
    </div>
