        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredTrainingData.map((data) => (
              <Card key={data.id} className="overflow-hidden border border-gray-600 bg-gray-900/80 backdrop-blur-sm transform hover:scale-102 transition-all duration-300 hover:shadow-lg hover:shadow-blue-400/20">
                <CardHeader className="p-4 pb-2 flex flex-row items-center justify-between bg-gradient-to-r from-blue-900/50 to-purple-900/50">
                  <CardTitle className="text-base text-gray-100">{data.title}</CardTitle>
                ...
                <CardContent className="p-4 pt-0">
                  ...
                  {data.category && (
                    <div className="flex flex-wrap gap-1 mb-2">
                      <Badge variant="outline" className="text-xs border-gray-600 text-blue-300">
                        {data.category}
                      </Badge>
                    </div>
                  )}
